...
The `mat_fun()` function fits a logistic regression of binary maturity (0 = immature, 1 = mature) as a function of a continuous predictor such as length or age:
...
`mat_fun()` works with any continuous predictor — here using age rather than length:
